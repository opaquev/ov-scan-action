...
- **License**: Changed from MIT to Business Source License 1.1, effective
  on the merge of this commit. Change Date 2030-05-06; Change License
  Apache 2.0. The Additional Use Grant permits any organization,
  regardless of size, to use the action in production CI or local
  development workflows for the sole purpose of invoking `ov scan`
  against repositories under their control; redistribution as part of a
  competing CI/secret-scanning offering or other overlapping commercial
  product is not authorized. See [LICENSE](LICENSE) for the precise
  wording. Previously-tagged releases (`v1.0.0`, `v1.0.1`, `v1.0.2`) at
  their respective git refs remain under MIT — pinning to those tags
  continues to receive MIT terms.
